  ...
  return (
    <div className={alignmentClass}>
      <div className={`flex items-center gap-3 ${eyebrowAlignment}`}>
        ...
        <p className="text-xs font-medium uppercase tracking-[0.12em] text-red-400">{eyebrow}</p>
      </div>
      <h2 className="headline-balance theme-text-primary mt-5 font-display text-3xl font-semibold tracking-[0.004em] sm:text-4xl lg:text-5xl">
        {title}
      </h2>
