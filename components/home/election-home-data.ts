...
export const plans = [
  {
    ...
    bestFor: 'Ideal for early-stage Sarpanch and smaller local-body campaigns.',
  ...
  },
  {
    ...
    bestFor: 'Designed for Nagar Palika and Nagar Parishad campaigns that need consistent momentum.',
  ...
  },
  {
    ...
    bestFor: 'Best for Nagar Nigam, chairman, mayor, and competitive urban local election campaigns.',
...
export const digitalEraReasons = [
  ...
  'A structured digital election strategy lets campaigns respond quickly when misinformation, attacks, or local narratives start moving.',
];
